...
public class WarriorLevelingTests {
    ...
    void levelUpAttributesChecker() {
        Hero heroJim = new Warrior("Jim");
        heroJim.levelUp();
        assertEquals(new HeroAttribute(8,4,2).getStr(), heroJim.getLevelAttributes().getStr());
        assertEquals(new HeroAttribute(8,4,2).getDex(), heroJim.getLevelAttributes().getDex());
        assertEquals(new HeroAttribute(8,4,2).getIntel(), heroJim.getLevelAttributes().getIntel());
    }
