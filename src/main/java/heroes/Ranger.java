...
/* In this child class of Hero, we define a Ranger specific hero which is good with dexterity. The two abstract classes
 * levelUp() and damage() are overwritten as a ranger gets experience in dexterity when leveling and this stat is used
 * for the damage calculations. A ranger starts with 1 strength, 7 dexterity and 1 intelligence points and is able to
 * equip bows as weapons, and leather & mail armor.
 *  */

public class Ranger extends Hero {

    //Constructor for our ranger. We use the name as provided by the user, and update the ranger's stats and equipable
    // items
    ...
    //Override the abstract levelUp method in Hero. Whenever a ranger gets to level up, we need to increase its level by
    //1 and increase its attributes by 1 strength, 5 dexterity and 1 intelligence points. For this we use the
    ...
    //Calculations for the damage output for a ranger are dependent on the weapon it's wearing and its dexterity.
